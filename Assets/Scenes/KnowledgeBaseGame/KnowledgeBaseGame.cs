...
/* TODO:
- use own namespace
- add rag support for simple lines
- test with proper vector search
...
namespace LLMUnitySamples
{
    public class KnowledgeBaseGame : KnowledgeBaseGameUI
    {
        ...
        public string ragPath = "KnowledgeBaseGame.zip";
        ...
        void InitElements()
        {
            ...
            // Retrieve characters from the scene
            characters = new List<Character>(FindObjectsByType<Character>(FindObjectsSortMode.None));

            // Add the characters to the dropdown
            List<string> characterNames = new List<string>();

            // Add character images and question answers to the dictionaries
            foreach (Character character in characters)
            {
                ...
                botImages[character.characterName] = character.characterImage;
                botQuestionAnswers[character.characterName] = LoadQuestionAnswers(character.characterKnowledge.text);
            }

            // Add the characters to the dropdown
            CharacterSelect.AddOptions(characterNames);
        }
        ...
        void InitLLM()
        {
            ...
            // warm up all characters
            foreach (Character llmCharacter in characters) {
        ...
        public async Task<List<string>> Retrieval(string question)
        {
            ...
            Debug.Log($"similar questions: {string.Join(", ", similarQuestions)}");
        ...
        public async Task<string> ConstructPrompt(string question)
        {
            ...
            Character character = characters.Find(character => character.characterName == currentBotName);
        ...
        protected async override void OnInputFieldSubmit(string question)
        {
            ...
            _ = character.Chat(prompt, SetAIText, AIReplyComplete);
        }
